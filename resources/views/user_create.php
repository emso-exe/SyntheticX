	...
	<div class="d-block">
		<form class="m-4" id="form-user-create" name="form-user-create" action="" method="POST" onSubmit="">
        	...
        	<div class="form-group">
				...
				<div class="col-md-12">
					<input class="form-control form-control-lg" id="cd_matricula" type="text" name="cd_matricula" placeholder="cd_matricula" onkeypress="" required>
				</div>
			</div>
        	...
        	<div class="form-group">
				...
				<div class="col-md-12">
					<input class="form-control form-control-lg" id="nm_nome" type="text" name="nm_nome" placeholder="nm_nome" onkeypress="" required>
				</div>
			</div>
			...
			<div class="form-row col-md-12 justify-content-center">
				<button class="btn btn-lg btn-success m-4 col-md-5" type="submit" name="gravar" value="1"><i class="fas fa-save"></i><span class="ml-4">CADASTRAR</span></button>
				<button class="btn btn-lg btn-warning m-4 col-md-5" type="reset" name="limpar" value="0"><i class="fas fa-eraser"></i><span class="ml-4">LIMPAR</span></button>
			</div>
