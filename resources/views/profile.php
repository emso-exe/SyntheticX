		...
		<form class="m-4" id="form-user-create" name="form-user-create" action="" method="POST" onSubmit="">
			...
			<div class="form-row">
				<div class="form-group col-md-4">
					...
					<p class="col-md-10 ml-3 text-primary" id="cd_matricula" name="cd_matricula" placeholder="cd_matricula">1001001</p>
				</div>
				<div class="form-group col-md-4">
					<label for="nm_login" class="col-md-2 col-form-label col-form-label-lg">Login</label>
					<p class="col-md-11 ml-3 text-primary" id="nm_login" type="text" name="nm_login" placeholder="nm_login">1001001estenio</p>
				</div>
				<div class="form-group col-md-4">
					<label for="cd_status" class="col-md-2 col-form-label col-form-label-lg">Status</label>
					<p class="col-md-10 ml-3 text-primary" id="cd_status" type="text" name="cd_status" placeholder="cd_status">ATIVO</p>
				</div>
			</div>

        	<div class="form-group">
				<label for="nm_nome" class="col-md-2 col-form-label col-form-label-lg">Nome</label>
				<p class="col-md-11 ml-3 text-primary" id="nm_nome" type="text" name="nm_nome" placeholder="nm_nome">ESTÊNIO CROCODILO MARIANO</p>
			</div>

			<div class="form-row">
    			<div class="form-group col-md-6">
					<label for="cd_setor" class="col-md-2 col-form-label col-form-label-lg">Setor</label>
      				<p class="col-md-10 ml-3 text-primary" id="setor" type="text" name="cd_setor" placeholder="cd_setor">CPD</p>
				</div>
    			<div class="form-group col-md-6" >
					<label for="cd_cargo" class="col-md-2 col-form-label col-form-label-lg">Cargo</label>
      				<p class="col-md-10 ml-3 text-primary" id="cd_cargo" type="text" name="cd_cargo" placeholder="cd_cargo">OPERADOR DE CPD</p>
				</div>
			</div>			
